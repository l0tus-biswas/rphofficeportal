...
const SEED_CARRIERS = [
  ...
  { name: 'Globe Term Life (GTL)',   category: ['Life Insurance', 'Supplemental Insurance'], factor: null, isActive: true, notes: 'Multi-category carrier — life & supplemental' },
...
async function resetCarriers() {
  try {
    ...
    SEED_CARRIERS.forEach(c => console.log(`  • [${c.category.join(', ')}] ${c.name}`));
